...
#
# Generated by Vivado on Thu Dec 15 13:17:46 EET 2016
...
# Script info
echo -e "gig_ethernet_pcs_pma_0.sh - Script generated by export_simulation (Vivado v2016.3 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot gig_ethernet_pcs_pma_0 xil_defaultlib.gig_ethernet_pcs_pma_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim gig_ethernet_pcs_pma_0 -key {Behavioral:sim_1:Functional:gig_ethernet_pcs_pma_0} -tclbatch cmd.tcl -log simulate.log
}
